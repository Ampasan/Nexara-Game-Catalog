...
- **Detail Game**
  - Halaman detail dengan deskripsi, rating bintang, screenshot gallery (fullscreen/zoom), dan trailer video (YouTube iframe).
- **Pencarian**
...
- **UI & Utilities**
  ...
  - `react-native-image-viewing` (image viewer untuk screenshot)
